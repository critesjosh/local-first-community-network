module.exports = {
  ...
  transformIgnorePatterns: [
    'node_modules/(?!(react-native|@react-native|@react-navigation|react-native-screens|react-native-safe-area-context|react-native-gesture-handler|expo-.*|@expo|@noble/ed25519|@noble/secp256k1|@noble/hashes|@noble/ciphers|@react-native-community)/)',
  ],
  moduleNameMapper: {
